...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/Bedroom.svg
  SvgGenImage get bedroom => const SvgGenImage('assets/icons/Bedroom.svg');
  ...
  SvgGenImage get creditCard => const SvgGenImage('assets/icons/Credit card.svg');

  /// File path: assets/icons/Date.svg
  SvgGenImage get date => const SvgGenImage('assets/icons/Date.svg');

  /// File path: assets/icons/Elevator.svg
  SvgGenImage get elevator => const SvgGenImage('assets/icons/Elevator.svg');
  ...
  /// File path: assets/icons/Hot water.svg
  SvgGenImage get hotWater => const SvgGenImage('assets/icons/Hot water.svg');

  /// File path: assets/icons/Locate.svg
  SvgGenImage get locate => const SvgGenImage('assets/icons/Locate.svg');

  /// File path: assets/icons/Map.svg
  SvgGenImage get map => const SvgGenImage('assets/icons/Map.svg');

  /// File path: assets/icons/Parking.svg
  SvgGenImage get parking => const SvgGenImage('assets/icons/Parking.svg');
